...
OPENAI_CLIENT = None
REFINE_PROMPTS = None
REFINE_PROMPTS_PATH = "docs/static/texts/t2v_pllava.txt"
...
def add_watermark(
    input_video_path, watermark_image_path="./docs/static/images/watermark/watermark.png", output_video_path=None
):
